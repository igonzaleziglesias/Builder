...
public class Pizza {
    ...
    private float gharina, mlAgua, grSal, mlAceite, grTomate, grQueso, grPinha;
    private String tipoAceite, tipoQueso;

    public Pizza(final float gharina, final float mlAgua, final float grSal, final float mlAceite, final float grTomate, final float grQueso, final float grPinha, final String tipoAceite, final String tipoQueso) {
